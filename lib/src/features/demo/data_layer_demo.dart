...
class _DataLayerExampleState extends ConsumerState<DataLayerExample> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ElevatedButton(
                          onPressed: _isRecording ? null : () => _startSession(),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: FutureBuilder<List<MeasurementSession>>(
                          future: dataService.sessionRepository.getRecentSessions(10),
  ...
  Future<void> _stopSession() async {
    ...
    final dataService = ref.read(dataServiceProvider);
    final session = await dataService.sessionRepository.getSession(_currentSessionId!);
  ...
  Future<void> _exportCsv() async {
    ...
    try {
      final result = await exportService.csvExportService.exportSession(_currentSessionId!);
  ...
  Future<void> _exportPdf() async {
    ...
    try {
      final result = await exportService.pdfReportService.generateReport(_currentSessionId!);
