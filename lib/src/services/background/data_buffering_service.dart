...
class DataBufferingService {
  ...
  final StreamController<BufferStatus> _statusController = StreamController<BufferStatus>.broadcast();
  ...
  Future<void> addEcgBatch(EcgSampleBatch batch) async {
    try {
      ...
      print('Error saving ECG batch: $e');
    }
  }
...
/// Placeholder for sample repository provider
final sampleRepositoryProvider = Provider<SampleRepository>((ref) {
  throw UnimplementedError('SampleRepository provider not implemented');
});